...
createServer({
  ...
  seeds(server) {
    server.create("van", {
      ...
      imageUrl: "../src/assets/vans/modest-explorer.png",
      type: "simple",
      hostId: "123"
    })
    ...
    server.create("van", {
      ...
      imageUrl: "../src/assets/vans/beach-bum.png",
      type: "rugged",
      hostId: "123"
    })
    server.create("van", {
      ...
      imageUrl: "../src/assets/vans/reliable-red.png",
      type: "luxury",
      hostId: "456"
    })
    server.create("van", {
      ...
      imageUrl: "../src/assets/vans/dream-finder.png",
      type: "simple",
      hostId: "789"
    })
    server.create("van", {
      ...
      imageUrl: "../src/assets/vans/cruiser.png",
      type: "luxury",
      hostId: "789"
    })
    server.create("van", {
      ...
      imageUrl: "../src/assets/vans/green-wonder.png",
      type: "rugged",
      hostId: "123"
    })
